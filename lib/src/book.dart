...
class XlBook {
  ...
  void loadPartially(String filename, int sheetIndex, int firstRow, int lastRow){
    var res = _xlBookLoadPartially(ptr, filename, sheetIndex, firstRow, lastRow);
    if (res == 0) {
      throw XlException(errorMessage());
    }
  }
  ...
  void loadPartiallyUsingTempFile(String filename, int sheetIndex, int firstRow, int lastRow, String tempFile){
    var res = _xlBookLoadPartiallyUsingTempFile(ptr, filename, sheetIndex, firstRow, lastRow, tempFile);
    if (res == 0) {
      throw XlException(errorMessage());
    }
  }
  ...
  num datePack(int year, int month, int day, int hour, int min, int sec, int msec){
