...
bool _xlSheetWriteFormulaBool(int ptr, int row, int col, String valueO, double valueT) native "_xlSheetWriteFormulaBool";
...
class XlSheet {
  ...
  writeFormulaBool(int row, int col, String valueO, double valueT) {
